...
class UtilFull {
    ...
    static GSYVideoOpenPlayer getVideoPlayer(ViewParent parent){
        if (parent instanceof GSYVideoOpenPlayer){
            return (GSYVideoOpenPlayer) parent;
        }else {
            return getVideoPlayer(parent.getParent());
        }
    }
