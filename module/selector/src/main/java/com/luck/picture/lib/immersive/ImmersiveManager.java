...
public class ImmersiveManager {
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
                ...
                ViewCompat.setOnApplyWindowInsetsListener(rootView, (v, windowInsets) -> {
                    ...
                    if (insetsCompat != null) {
                        ...
                        v.setBackgroundColor(navigationBarColor);
                    } else {
                        rootView.setPadding(rootView.getPaddingLeft(), 0, rootView.getPaddingRight(), 154);
                        rootView.setBackgroundColor(navigationBarColor);
                    }
                ...
                if (isMarginStatusBar && isMarginNavigationBar) {
                    ...
                    LightStatusBarUtils.setLightStatusBar(baseActivity, true, true, statusBarColor == Color.TRANSPARENT, isDarkStatusBarIcon);
                    ...
                    LightStatusBarUtils.setLightStatusBar(baseActivity, false, false, statusBarColor == Color.TRANSPARENT, isDarkStatusBarIcon);

                    window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
                } else if (!isMarginStatusBar) {
                    window.requestFeature(Window.FEATURE_NO_TITLE);
                    window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS | WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
                    LightStatusBarUtils.setLightStatusBar(baseActivity, false, true, statusBarColor == Color.TRANSPARENT, isDarkStatusBarIcon);
    ...
    private static void setupStatusBarView(Activity activity) {
        ...
        if (statusBarView == null) {
            ...
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, DensityUtil.getStatusBarHeight(activity));
