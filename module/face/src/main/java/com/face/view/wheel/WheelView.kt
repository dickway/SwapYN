...
open class WheelView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    @JvmField
    var mClipRectMiddle: RectF? = null
    @JvmField
    ...
    @JvmField
    var mScroller: com.face.view.wheel.WheelScroller

    val mEntries: MutableList<CharSequence> = mutableListOf()
    ...
    init {
        ...
        val textColor =
            a.getColor(R.styleable.WheelView_wheelTextColor, `$color`(R.color.wheel_text_color))
        ...
        mTextPaint.textSize = textSize.toFloat()-6
        ...
        mDividerPaint.strokeWidth =
            resources.getDimensionPixelOffset(R.dimen.wheel_divider_height)
                .toFloat()
        ...
        mScroller = com.face.view.wheel.WheelScroller(context, this)
    }
    ...
    private fun updateClipRect() {
        ...
        mClipRectMiddle = RectF()
        mClipRectMiddle!!.left = clipLeft.toFloat()
        mClipRectMiddle!!.right = clipRight.toFloat()
        mClipRectMiddle!!.top = (clipVMiddle - mItemHeight / 2).toFloat()
        mClipRectMiddle!!.bottom = (clipVMiddle + mItemHeight / 2).toFloat()
    ...
    private fun drawHighlight(canvas: Canvas) {
        canvas.drawRoundRect(mClipRectMiddle!!, 6.dp.toFloat(), 6.dp.toFloat(), mHighlightPaint)
    }
    ...
    var onWheelChangedListener: com.face.view.wheel.OnWheelChangedListener?
