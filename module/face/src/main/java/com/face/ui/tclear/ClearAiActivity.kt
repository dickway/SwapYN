...
import com.face.BR
import com.face.R
import com.face.databinding.ActivityAiclearBinding
import com.face.util.GVM
import com.face.view.CancelClearDialog
import com.face.viewmodel.activity.ClearAiViewModel
...
class ClearAiActivity : BaseBindingActivity<ActivityAiclearBinding, ClearAiViewModel>(
    R.layout.activity_aiclear,
    ClearAiViewModel::class.java
) {
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        Glide.with(this@ClearAiActivity).asBitmap()
            .load(imgUrl)
        ...
        mModel.saveAiclearBean.observe(this) {
            if (it != null) {
                openActivity<ClearCompletionActivity>() {
