...
import com.face.databinding.ActivityAistyleBinding
import com.face.ui.ToolCompletionActivity
import com.face.util.GVM
import com.face.util.SPUtils
import com.face.view.CancelClearDialog
import com.face.viewmodel.activity.StyleAiViewModel
...
class StyleAiActivity : BaseBindingActivity<ActivityAistyleBinding, StyleAiViewModel>(
    R.layout.activity_aistyle,
    StyleAiViewModel::class.java
) {

    val styleKey by intentExtras("style", "")
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        mModel.style = styleKey
        Glide.with(this@StyleAiActivity).asBitmap()
            .load(imgUrl)
