...
import com.face.databinding.ActivityAirestorationBinding
import com.face.ui.ToolCompletionActivity
import com.face.util.GVM
import com.face.util.SPUtils
import com.face.view.CancelClearDialog
import com.face.viewmodel.activity.RestorationAiViewModel
...
class RestorationAiActivity :
    BaseBindingActivity<ActivityAirestorationBinding, RestorationAiViewModel>(
        R.layout.activity_airestoration,
        RestorationAiViewModel::class.java
    ) {
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        Glide.with(this@RestorationAiActivity).asBitmap()
            .load(imgUrl)
            ...
            .into(object : CustomTarget<Bitmap>() {
                ...
                override fun onResourceReady(
                    ...
                    val heights = (getScreenHeight() - 224.dp)//控件最大高度
        ...
        mModel.countdown.observe(this) {//显示等待时间
            if (!it.equals("") && it != "0s") {
                if (mModel.progressNum.value > 98) {
                    mBinding?.txtTime?.text = "${getStringX(R.string.clear_already_time)} $it"
                } else {
                    mBinding?.txtTime?.text = "${getStringX(R.string.clear_expected_time)} $it"
                }
            }
        }
