...
public class CustomManager extends GSYVideoBaseManager {
    ...
    public static void releaseAllVideos(String key) {
        ...
        getCustomManager(key).getPlayManager().releaseSurface();
        getCustomManager(key).getPlayManager().release();
    }
    ...
    public static void needMuteVideo(String tag,Boolean needMute) {
        if (!sMap.isEmpty()) {
            for (Map.Entry<String, CustomManager> header : sMap.entrySet()) {
                if (header.getKey().contains(tag)) {
                    getCustomManager(tag).needMute=needMute;
                }
            }
        }
        sMap.clear();
    ...
    public static void clearAllVideo(String tag) {
        if (!sMap.isEmpty()) {
            for (Map.Entry<String, CustomManager> header : sMap.entrySet()) {
                if (header.getKey().contains(tag)) {
                    CustomManager.releaseAllVideos(header.getKey());
