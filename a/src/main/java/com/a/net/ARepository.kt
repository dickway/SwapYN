...
object ARepository : BaseRepository() {

    private var service = ARetrofitClient.getService()

    private var service2 = ARetrofitClient.getService2()
    ...
    suspend fun saveUserAiMedia(
        ...
        service.saveUserAiMedia(type, url, tags, hw, param, imgUrl)
    }
...
//    }
    ...
    suspend fun googleLogin(type: String = "google", id: String, token: String) = executeHttp {
        service.googleLogin(type, thirdId = id, authToken = token)
    }
    ...
    suspend fun bindGuestUser(id: String, token: String) = executeHttp {
        service.bindGuestUser(id, token)
    }
    ...
    suspend fun shareHotMedia(page: Int = 1, video_type: String = "") =
        executeHttp {
            ...
            service.shareHotMedia(page = page, videoType = type, mediaType = media_type)
        }
